<?php
/**
 * Kids Corner Layout Template
 * Pure row-based layout: Icon + Title + Controls, Description, Unit Price, Total/Free
 *
 * Variables available:
...
<div class="aura-products-wrapper" data-widget-id="<?php echo esc_attr( $widget_id ); ?>">
	<div class="aura-products-grid"
		...
		<?php foreach ( $products as $index => $product ) :
			...
			$is_free = ( floatval( $product_price ) == 0 );
		?>

		<div class="aura-product-card aura-kids-card <?php echo esc_attr( $is_hidden ); ?>"
			 data-product-id="<?php echo esc_attr( $product_id ); ?>"
			 data-product-price="<?php echo esc_attr( $product_price ); ?>">

			<!-- Row 1: Icon + Title (left) | Controls (right) -->
			<div class="aura-kids-header">
				<div class="aura-kids-title-wrapper">
					<div class="aura-kids-icon"
			...
			<?php if ( ! empty( $product_description ) ) : ?>
				<div class="aura-kids-description">
